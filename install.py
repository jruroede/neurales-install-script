...
def install_function():
    os.system('sudo apt-get install -y python3-pip libopenblas-base libopenmpi-dev build-essential cmake git libgtk2.0-dev libgtk-3-dev pkg-config libgstreamer-plugins-base1.0-dev libgstreamer1.0-dev libavcodec-dev libavformat-dev libswscale-dev python3-dev python3-numpy libtbb2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libdc1394-22-dev gcc g++ python-opencv')
